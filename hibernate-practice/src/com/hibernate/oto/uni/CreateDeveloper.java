...
public class CreateDeveloper {
	...
	public static void main(String[] args) {
		...
		try {			
			...
			Developer developer = new Developer("Hermoine", "Angular", "hermoine.granger@hogwarts.com");
			
			DeveloperDetail developerDetail = new DeveloperDetail("https://github.com/hermoine-granger","AliBaba");
